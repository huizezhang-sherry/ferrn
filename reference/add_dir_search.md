...
- dir_size:
  ...
  numeric; the size of the directional search points in pseudo
  derivative search

- dir_alpha:

  numeric; the alpha of the directional search points in pseudo
  derivative search
...
a wrapper for drawing directional search points (used in pseudo
derivative search) with buffer in
[`explore_space_pca()`](https://huizezhang-sherry.github.io/ferrn/reference/explore_space_pca.md)
